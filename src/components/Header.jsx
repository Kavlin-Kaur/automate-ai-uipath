    ...
    <header className="mx-auto max-w-6xl px-4 pt-6 sm:pt-8 md:pt-10 pb-4 sm:pb-6">
      <div className="relative glass rounded-2xl p-5 sm:p-6 md:p-8 gradient-border card-hover">
        <div className="absolute right-3 sm:right-4 top-3 sm:top-4">
          <span className="inline-flex items-center gap-1.5 rounded-full border border-[#FA4616] bg-white/10 px-3 py-1 text-xs font-semibold text-white hover:bg-white/15 transition-all">
            <BadgeCheck className="h-4 w-4 text-[#FA4616]" />
            UiPath Compatible
          </span>
        </div>
        <div className="flex flex-col sm:flex-row items-start gap-4 pr-32 sm:pr-0">
          <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-[#FA4616] to-orange-400 shadow-lg shadow-orange-500/50 flex-shrink-0">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="mt-2 text-white/70 text-xs sm:text-sm md:text-base flex items-center gap-2">
